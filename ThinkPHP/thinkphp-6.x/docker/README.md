...
```bash
sudo chown -R www-data:www-data /var/www/thinkphp6
sudo find /var/www/thinkphp6 -type f -exec chmod 644 {} \;
sudo find /var/www/thinkphp6 -type d -exec chmod 755 {} \;
```
